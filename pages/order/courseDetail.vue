  ...
  <view class="uni-content">
    ...
    <view class="detail">
      ...
      <template v-if="model.order_state == 5 || model.order_state == 10">
        <view class="pay-title">课程已购买</view>
          ...
          <view class="detail-item">
            ...
            <view class="item-right">
              ...
              <view class="item-type"
                >共{{ model.associationModel.class_hour }}课时</view
              >
      ...
      <view class="btns" v-if="model.order_state == 5"
        ><view class="btn pay whole" @click="openCourse">兑换课程</view></view
      >
      <!-- 已兑换 -->
      <view class="btns" v-if="model.order_state == 10"
        ><view class="btn disable whole">课程已兑换</view></view
      >
      <!-- 已取消-->
      <view class="btns" v-if="model.order_state == 20">
        <navigator
          ...
          >返回订单列表</navigator
        >
        <navigator url="/pages/course/index" hover-class="none" class="btn pay"
          >浏览更多课程</navigator
        >
      </view>
    </view>
          ...
          uni.requestPayment({
            ...
            success(payRes) {
              ...
              if (payRes.errMsg === 'requestPayment:ok') {
                uni.redirectTo({
                  url: '/pages/order/result?type=2&id=' + self.model.order_id
                })
              }
            },
            fail(payRes) {
